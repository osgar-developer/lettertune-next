...
Mark Hamilton`)
  ...
  return (
    <div className="card card-hover animate-in animate-delay-1 bg-[rgba(255,255,255,0.85)] border border-[rgba(31,42,26,0.12)] rounded-xl shadow-[0_10px_28px_rgba(31,42,26,0.12)] overflow-hidden">
