    ...
    <label className="flex flex-col gap-2">
      ...
      {isTextArea ? (
        <textarea
          ...
          className="w-full border border-[rgba(31,42,26,0.12)] bg-[rgba(255,255,255,0.95)] text-[#1f2a1a] rounded-lg p-3 outline-none resize-vertical min-h-[120px] text-[13px]"
