import { CoverLetterResponse, ModelId, GeneratePayload } from './types'
...
const JSON_SCHEMAInstructions = `Output a valid JSON object with this exact schema:
{
